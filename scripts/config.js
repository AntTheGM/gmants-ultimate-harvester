...
/**
 * Foraging failure events — randomly selected when a failed forage roll triggers a consequence.
 * Trigger: Natural 1 always triggers. Otherwise 1% chance per point missed below lowest tier DC.
 * Each event has a label, icon, description (posted to chat), and an optional `auto` key
 * indicating what can be applied programmatically.
 */
export const FORAGING_FAILURE_EVENTS = [
  {
    id: "poison-plant",
    label: "Poisonous Plant",
    icon: "fas fa-skull-crossbones",
    description: "You handle a poisonous plant and suffer for it. Take <strong>{damage}</strong> poison damage.",
    damageFormula: "2 * @level",
    damageType: "poison",
    auto: "damage",
  },
  {
    ...
    label: "Exhaustion",
    icon: "fas fa-bed",
    description: "Hours of fruitless searching in harsh conditions leave you drained. Gain <strong>1 level of exhaustion</strong>.",
    auto: "exhaustion",
  },
  {
    id: "lost-supplies",
    ...
    description: "While rummaging through underbrush, you lose track of your belongings. <strong>Lose one item worth over 1 sp</strong> (player's choice).",
    auto: "none",
  },
  {
    id: "scattered-ammo",
    label: "Scattered Ammunition",
    icon: "fas fa-arrows-alt",
    description: "Your quiver catches on a branch and scatters its contents. <strong>Lose half your ammunition of one type</strong> (rounded down).",
    auto: "ammo",
  },
  {
    id: "twisted-ankle",
    ...
    description: "You step in a hidden animal burrow and twist your ankle. <strong>Speed reduced by 10 ft</strong> until your next long rest.",
    auto: "effect",
    effect: {
      name: "Twisted Ankle",
      ...
      description: "Speed reduced by 10 ft from a foraging mishap.",
    },
  },
  {
    id: "spoiled-rations",
    label: "Spoiled Rations",
    icon: "fas fa-drumstick-bite",
    description: "Something foul from the wilds contaminates your pack. <strong>{spoilCount} ration(s)</strong> in your inventory have spoiled.",
    spoilFormula: "1d4",
    auto: "none",
  },
  {
    id: "attracted-predators",
    label: "Attracted Predators",
    icon: "fas fa-paw",
    description: "Your clumsy foraging attracts unwanted attention. The GM should roll on the <strong>random encounter table</strong>.",
    auto: "none",
  },
  {
    id: "rash",
    ...
    description: "You brush against something irritating and break out in an angry, weeping rash. <strong>-4 penalty to Perception</strong> for 24 hours.",
    auto: "effect",
    effect: {
      name: "Nasty Rash",
      ...
      durationHours: 24,
      changes: [
        { key: "system.skills.prc.bonuses.check", mode: 2, value: "-4" },
      ],
      description: "-4 penalty to Perception from a foraging rash.",
    },
  },
  {
    id: "insect-swarm",
    label: "Stung by Insects",
    icon: "fas fa-bug",
    description: "You disturb a nest of stinging insects. Take <strong>{damage}</strong> poison damage and have <strong>disadvantage on Concentration</strong> checks for 1 hour.",
    damageFormula: "1d4",
    damageType: "poison",
    auto: "damage+effect",
    effect: {
      name: "Insect Stings",
      icon: "icons/creatures/invertebrates/bee-yellow.webp",
      durationHours: 1,
      changes: [
        { key: "flags.midi-qol.disadvantage.ability.check.con", mode: 0, value: "1" },
        { key: "flags.midi-qol.disadvantage.ability.save.con", mode: 0, value: "1" },
      ],
      description: "Disadvantage on Concentration checks for 1 hour from insect stings.",
    },
  },
  {
    id: "sprained-ankle",
    ...
    icon: "fas fa-compass",
    description: "You lose your footing on uneven ground and badly sprain your ankle. <strong>-5 ft movement speed</strong> for 24 hours.",
    auto: "effect",
    effect: {
      name: "Sprained Ankle",
      icon: "icons/skills/movement/feet-winged-sandals-tan.webp",
      ...
      description: "-5 ft movement from a sprained ankle while foraging.",
    },
  },
];
